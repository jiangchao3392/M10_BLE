...
{ 
	SetWord16(GP_ADC_CTRL_REG,   mode | sign | GP_ADC_LDO_EN );//  | GP_ADC_MUTE| GP_ADC_CLK_SEL
	SetWord16(GP_ADC_CTRL_REG,   GP_ADC_LDO_EN |mode | GP_ADC_EN | sign );//| GP_ADC_CHOP| GP_ADC_LDO_ZERO
