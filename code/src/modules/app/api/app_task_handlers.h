...
EXTERN const struct ke_msg_handler app_default_state[] =
{
    ...
    {UART_TIMER,                             (ke_msg_func_t)uart_handle},//´®¿ÚÈÎÎñ
	  {ADC_TIMER,                              (ke_msg_func_t)adc_timer_handle},
		{MOTOR_TIMER,                            (ke_msg_func_t)motor_handle},
		{MOTOR_RESET,                           (ke_msg_func_t)motor_reset_handle},
		{KEY_SCAN,                              (ke_msg_func_t)key_scan_handle},
		{KEY_DISPOSE,                            (ke_msg_func_t)key_dispose_handle},
...
//    {APP_EXT_TRANSMIT_CMD,                 (ke_msg_func_t)app_ext_transmit_cmd_handler},
  ...
  {MY_TIMER,                   (ke_msg_func_t)my_timer_handler},	
}; 
